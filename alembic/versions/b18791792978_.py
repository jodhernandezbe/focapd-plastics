...
Revision ID: b18791792978
Revises:
Create Date: 2024-11-03 10:21:28.045821
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("naics_code", "naics_title", name="unique_column_code_title"),
    )
    op.create_table(
        "industry_use_sector",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        "record",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column("trifid", sa.String(), nullable=False),
        sa.Column("additive_id", sa.Integer(), nullable=False),
